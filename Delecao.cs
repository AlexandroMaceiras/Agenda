...
{
	/// <summary>
	/// Tela de deleção de registros.
	/// </summary>
	public class Delecao : System.Windows.Forms.Form
	{
		...
		/// <summary>
		/// Construtor que desabilita o botão de deleção ao iniciar.
		/// </summary>
		public Delecao()
		{
			InitializeComponent();
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Delecao));
		...
		/// <summary>
		/// Faz a procura dos registros pelo nome antes de deletar.
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		...
		/// <summary>
		/// Evento que acontece quando se seleciona algum dos registros listados
		/// para a futura deleção.
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
			...
			try
			{
				if(dataGrid1.CurrentRowIndex >= 0) 
				{
					...
					if(
						...
						+ "\nTelefone 4 : " 
						+ Telefone4.ToString()
						,"Selecionar este registro para deletar ?"
